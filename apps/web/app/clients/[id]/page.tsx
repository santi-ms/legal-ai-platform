...
import { getClient, updateClient, deleteClient, Client, ClientPayload, ClientType } from "@/app/lib/webApi";
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      <div className="max-w-[960px] mx-auto px-4 md:px-10 py-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-5">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl border border-dashed border-slate-200 dark:border-slate-700 p-8 flex flex-col items-center text-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 dark:text-slate-500 mt-0.5">
                Próximamente podrás ver y generar documentos directamente desde el perfil del cliente.
              </p>
            </div>
          </div>
        </div>
