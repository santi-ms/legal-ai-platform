...
import { getClient, updateClient, deleteClient, listDocuments, Client, ClientPayload, ClientType, Document } from "@/app/lib/webApi";
...
export default function ClientDetailPage() {
  ...
  useEffect(() => {
    if (!authLoading && isAuthenticated) { load(); loadDocs(); }
