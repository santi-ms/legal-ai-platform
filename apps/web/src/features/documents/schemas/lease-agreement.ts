  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        {
          id: "ajuste_precio",
          label: "Mecanismo de Ajuste del Canon",
          type: "select",
          required: false,
          helpText: "Opcional: define cómo se actualizará el valor del alquiler",
          options: [
            { value: "ninguno", label: "Sin ajuste" },
            { value: "icl", label: "Índice Casa Propia (ICL - BCRA)" },
            { value: "inflacion", label: "Índice de Precios al Consumidor (IPC)" },
