  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
      ...
      <p className="text-sm text-slate-500 dark:text-slate-400 max-w-sm mb-6">
        Describile a la IA qué documento necesitás y lo generamos en minutos. Contratos, NDAs, cartas documento y más.
      </p>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="min-w-0">
                            ...
                            {doc.matchSnippet ? (
                              <div className="text-xs text-slate-500 dark:text-slate-400 mt-0.5 max-w-[260px] truncate italic">
                                {doc.matchSnippet}
                              </div>
                            ) : (
