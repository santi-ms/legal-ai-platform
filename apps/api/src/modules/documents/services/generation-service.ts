...
Priorizás concisión, claridad y aptitud postal sobre el lucimiento jurídico.`,
      baseInstructions: [
        "FORMATO: texto plano únicamente — PROHIBIDO usar HTML, Markdown, etiquetas, ni ningún formato especial. Solo texto corrido.",
        "ESTRUCTURA OBLIGATORIA — en este orden exacto, sin títulos de sección ni numeración romana:",
        "  1. Ciudad y fecha alineada a la derecha (ej: 'Buenos Aires, 6 de abril de 2026')",
        "  2. REMITENTE: nombre, DNI/CUIT, domicilio — todo en una línea",
        "  3. DESTINATARIO: nombre, DNI/CUIT, domicilio — todo en una línea",
        "  4. El título CARTA DOCUMENTO va solo en su línea, centrado, en mayúsculas — sin etiquetas HTML",
        "  5. Cuerpo en texto corrido, SIN secciones ni encabezados — exactamente 3 párrafos:",
        "     Párrafo 1: una sola oración con el contexto mínimo — qué relación existe y cuál es el origen del reclamo.",
        "     Párrafo 2: el reclamo directo — monto exacto en números y letras, concepto, fecha de vencimiento, situación de mora, y medio de pago si lo hay. Hablar de 'Ud.' no de 'el destinatario' ni 'el intimado'.",
        "     Párrafo 3: la intimación — 'Por la presente INTIMA FEHACIENTEMENTE a Ud. a [acción concreta] dentro del plazo de [N días hábiles/corridos]'. Apercibimiento: acciones judiciales + intereses + costas. SIN amenaza penal.",
        "  6. Cierre: 'Sin otro particular, saludo a Ud. atentamente.' — ya incluido en la plantilla, NO repetirlo",
        "PERSONAS: usar siempre 'Ud.' en lugar de 'el destinatario', 'la intimada', 'el deudor' u otras referencias en tercera persona",
        "NO citar artículos del CCCN ni otros cuerpos normativos",
        "NO repetir nombre completo, CUIT ni domicilio del destinatario más de una vez en el cuerpo",
        "NO usar: 'grave e injustificado', 'causa fuente', 'todos los efectos jurídicos', 'de inmediato', 'conforme lo estipulado contractualmente'",
        "INTERESES: usar 'más los intereses que correspondan desde la fecha de vencimiento' — no especificar tasa salvo indicación expresa del usuario",
        "FIRMA: NO agregar CUIT ni domicilio del remitente en el bloque de firma — solo nombre y 'Firma y aclaración'",
        "El documento es definitivo — todos los datos completos con valores reales, sin placeholders",
      ],
    };
  }
